...
- Public-safe LLM visibility files.
- Clear topic hubs for technology, AI companions, Smart City, Smart Mobility, and ChornPlanet identity.
...
- top landing pages
- pages with search impressions but weak titles/descriptions
...
Traffic goals guide prioritization. Agents must not invent metrics. If data is unavailable, create an instrumentation gap note and propose the smallest safe way to gather the signal.
