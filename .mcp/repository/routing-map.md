...
- Localized public pages are under `src/app/[locale]/(desktop)/`.
- The route group `(desktop)` does not appear in URLs.
...
- Home: `src/app/[locale]/(desktop)/page.tsx`
...
- `src/app/[locale]/(desktop)/smart-city/[slug]/page.tsx`
...
- Page under `src/app/[locale]/(desktop)/.../page.tsx`
