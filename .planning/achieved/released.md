...
| Smart Food AI Production Showcase | Platform Page | `src/app/[locale]/(legacy)/smart-food-ai/page.tsx`<br>`src/app/[locale]/(roadmap)/smart-food/page.tsx`<br>`src/components/SmartFood/SmartFoodLandingPage.tsx`<br>`src/lib/smart-food-ai-content/smartFoodAiContent.service.ts`<br>`src/styles/platform/smart-food.scss` |
| Smart Food AI Server Error Fallback Rendering | Reliability Fix | `src/metadata/main/MetadataSmartFoodAi.ts`<br>`src/components/SmartFood/SmartFoodLandingPage.tsx`<br>`src/lib/static-content/publicContentFallbacks.ts` |
...
| MCP Phase 2 Platform Roadmap | Agent Workspace | `.mcp/roadmap/business-core.md`<br>`.mcp/roadmap/growth-milestones.md`<br>`.mcp/analytics/` |
| MTS Future Civilization Platform | Platform Page | `src/app/[locale]/(legacy)/smart-mobility/page.tsx`<br>`src/app/[locale]/(legacy)/smart-mobility/mts/[slug]/page.tsx`<br>`src/app/[locale]/(roadmap)/story/page.tsx`<br>`src/lib/platform-content/smartMobilityContent.ts`<br>`src/data/smart-mobility/`<br>`src/data/story/sofa-couple/en.sofa-couple.json` |
